...
```bash
# Download and install Debian package (replace VERSION with actual version, e.g. 2.3.11)
...
```bash
# Download and install Ubuntu package (replace VERSION with actual version, e.g. 2.3.11)
