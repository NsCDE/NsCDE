...
def CalculateColorsForDarkBackground(bg_color):
    ...
    bs_color=[0,0,0]
    ts_color=[0,0,0]
    disabled_fg_color=[0,0,0]
    brightness=Brightness(bg_color)
    if (brightness > XmFOREGROUND_THRESHOLD):
        fg_color[0] = 0 
        fg_color[1] = 0 
        fg_color[2] = 0
        disabled_fg_color[0] = 32768
        disabled_fg_color[1] = 32768
        disabled_fg_color[2] = 32768
    else:
        fg_color[0] = XmMAX_SHORT 
        fg_color[1] = XmMAX_SHORT 
        fg_color[2] = XmMAX_SHORT
        disabled_fg_color[0] = 45800
        disabled_fg_color[1] = 45800
        disabled_fg_color[2] = 45800
    ...
    return (fg_color,sel_color,bs_color,ts_color,disabled_fg_color)
...
def initcolors(palette,endrange):
    ...
    for a in range(1,endrange):
        ...
        if backgroundbrightness < XmCOLOR_DARK_THRESHOLD:
            (fg_color,sel_color,bs_color,ts_color,disabled_fg_color) = CalculateColorsForDarkBackground(bg_color)
        elif backgroundbrightness > XmCOLOR_LITE_THRESHOLD:
            (fg_color,sel_color,bs_color,ts_color,disabled_fg_color) = CalculateColorsForLightBackground(bg_color)
        else:
            (fg_color,sel_color,bs_color,ts_color,disabled_fg_color) = CalculateColorsForMediumBackground(bg_color)
        ...
        disb[a]=rgbToHex(disabled_fg_color)
    if use_4_colors:
        equal_colors_ab(5,2)
        equal_colors_ab(6,2)
        equal_colors_ab(8,2)
...
def round_colors_6():
    for a in range(1,9):
        ...
        disb[a]='#'+disb[a][1:3]+disb[a][5:7]+disb[a][9:11]
...
def gencdecolors(palettefile,n,infile,outdir,fext,shorten_colorhex):
    ...
    replacement_dict = {'NSCDE_BG_COLOR_1':bgg[1], 'NSCDE_BG_COLOR_2':bgg[2],
                        ...
                        'NSCDE_FG_COLOR_5':fgg[5], 'NSCDE_FG_COLOR_6':fgg[6],
                        ...
                        'NSCDE_TS_COLOR_5':tsg[5], 'NSCDE_TS_COLOR_6':tsg[6],
                        ...
                        'NSCDE_BS_COLOR_5':bsg[5], 'NSCDE_BS_COLOR_6':bsg[6],
                        ...
                        'NSCDE_SEL_COLOR_5':selg[5], 'NSCDE_SEL_COLOR_6':selg[6],
                        'NSCDE_SEL_COLOR_7':selg[7], 'NSCDE_SEL_COLOR_8':selg[8],
                        'NSCDE_DISABLED_FG_COLOR_1':disbg[1], 'NSCDE_DISABLED_FG_COLOR_2':disbg[2],
                        'NSCDE_DISABLED_FG_COLOR_3':disbg[3], 'NSCDE_DISABLED_FG_COLOR_4':disbg[4],
                        'NSCDE_DISABLED_FG_COLOR_5':disbg[5], 'NSCDE_DISABLED_FG_COLOR_6':disbg[6],
                        'NSCDE_DISABLED_FG_COLOR_7':disbg[7], 'NSCDE_DISABLED_FG_COLOR_8':disbg[8]}
