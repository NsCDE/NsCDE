...
function install_nscde
{
   ...
   if [ -d "NsCDE" ]; then
      ...
      mkdir -p "${instpath}/share/locale/hr"
      mkdir -p "${instpath}/share/locale/hr/LC_MESSAGES"
      cp -f NsCDE/bin/nscde "${instpath}/bin/nscde"
      cp -f NsCDE/bin/nscde_fvwmclnt "${instpath}/bin/nscde_fvwmclnt"
      cp -rpf NsCDE/libexec/NsCDE "${instpath}/libexec/"
      cp -rpf NsCDE/lib/NsCDE "${instpath}/lib/"
      cp -rpf NsCDE/share/NsCDE "${instpath}/share/"
      cp -f NsCDE/share/applications/NsCDE-* "${instpath}/share/applications/"
      cp -f NsCDE/share/desktop-directories/nscde-* "${instpath}/share/desktop-directories/"
      cp -rpf NsCDE/share/doc/NsCDE "${instpath}/share/doc/"
      cp -rpf NsCDE/share/icons/NsCDE "${instpath}/share/icons/"
      cp -rpf NsCDE/share/locale/hr/LC_MESSAGES/NsCDE* "${instpath}/share/locale/hr/LC_MESSAGES/"
      retval="$?"
      if (($retval == 0)); then
         echo "Done."
      else
